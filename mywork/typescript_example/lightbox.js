...
var images = ['images/1.jpg', 'images/2.jpg', 'images/3.jpg', 'images/4.jpg', 'images/5.jpg', 'images/6.jpg']; // Images Array
// Opens Lightbox
function open_modal() {
...
function change_image(n) {
    document.getElementById("active_image").src = images[n];
    current_slide = n;
...
function next_slide(n) {
    if (current_slide < 1 && n == -1) {
        ...
        document.getElementById("active_image").src = images[current_slide];
        return current_slide;
    }
